<template>
  <div class="navbar_main">
    ...
    <div class="nav_left">
      <ul>
        <li class="nav_left_item" @click="returnbilibili">
          <a href="#">
        ...
        <li class="nav_left_item">
          <el-popover placement="bottom-start" trigger="hover">
            ...
            <a slot="reference">
              <a
                href="https://live.bilibili.com/?spm_id_from=333.851.b_696e7465726e6174696f6e616c486561646572.4"
                >直播</a
              ></a
            >
          </el-popover>
        ...
        <li class="nav_left_item">
          <el-popover placement="bottom-start" trigger="hover">
            <div class="nav-cartoon">
              <div class="n-g-left">
                <div class="n-c-img">
                  <img src="../../assets/img/meizi.jpg" alt="" />
                </div>
                <div class="n-g-recommend">
                  <span class="recommend-item">
                    <img src="../../assets/img/gongzuo.jpg" alt="" />
                  </span>
                  <span class="recommend-item">
                    <img src="../../assets/img/gui.jpg" alt="" />
                  </span>
                  <span class="recommend-item">
                    <img src="../../assets/img/bihai.jpg" alt="" />
                  </span>
                </div>
              </div>
              <el-divider direction="vertical"></el-divider>
              <div class="n-g-right">
                <ul>
                  <li class="n-title">
                    <strong class="title">人气漫画</strong>
                  </li>
                  <li class="n-g-title">1.天宫赐福</li>
                  <li class="n-g-title">2.妹子太多，只好...</li>
                  <li class="n-g-title">3.鬼刀之刃</li>
                  <li class="n-g-title">4.工作的细胞</li>
                  <li class="n-g-title">5。碧蓝之海</li>
                  <li class="n-g-title">6.一拳超人/li></li>
                </ul>
              </div>
            </div>
            <a slot="reference"
              ><a
                href="https://manga.bilibili.com/?from=bill_top_mnav&spm_id_from=333.851.b_696e7465726e6174696f6e616c486561646572.6"
                >漫画</a
              ></a
            >
          </el-popover>
        ...
        <li class="nav_left_item">
          <a
            href="https://www.bilibili.com/v/game/match/?spm_id_from=333.851.b_696e7465726e6174696f6e616c486561646572.7"
            >赛事</a
          >
        </li>
        <li class="nav_left_item">
        ...
        <li class="nav_right_item">
          <el-popover placement="bottom-start" trigger="hover">
            <div class="user">
              <ul>
                <li class="message-item">
                  <span class="homepage" @click="gotohomepage">个人中心</span>
                  <!-- <el-divider class="divied"></el-divider> -->
                </li>
                ...
                <li class="message-item">
                  <span>收到的赞</span>
                  <!-- <el-badge :value="999" class="item message-item-spot">
                    <span>&nbsp;</span>
                  </el-badge> -->
                </li>
                <li class="message-item">
            ...
            <a slot="reference"
              ><el-avatar
                size="medium"
                src="https://redblack.oss-cn-beijing.aliyuncs.com/touxiang.jpg"
              ></el-avatar
            ></a>
          </el-popover>
        </li>
