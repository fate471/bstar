  ...
  <div id="home">
    <el-container>
      ...
      <el-header class="min_width">
        ...
        <div class="banner">
          <img
            src="https://redblack.oss-cn-beijing.aliyuncs.com/banner.png"
            alt=""
          />
        </div>
      </el-header>
      ...
      <el-main>
        ...
        <div class="b-wrap tab_main">
          ...
          <div class="tab_center">
            ...
            >
              <el-popover placement="top-start" width="130" trigger="hover">
                <div class="cat-item">
                  <div
                    class="cat"
  ...
  methods: {
    ...
    async getTabsList() {
      const { data: res } = await axios.get(
        "https://www.fastmock.site/mock/2536e5c5382e169a3ad3beaffa803d4d/bilibili/api/nav"
      );
      // if (res.code !== 0) {
      //   return;
      // }
    ...
    async getMainDataList() {
      ...
      for (let i = 0; i < 4; i++) {
        ...
        let randNum = parseInt(Math.random() * len);
        this.swiperList.push(res.data.info[randNum]);
      }

      for (let i = 4; i < 10; i++) {
        // console.log(res.data.info);
        let randNum = parseInt(Math.random() * len);
        this.swiperList_r.push(res.data.info[randNum]);
      }
